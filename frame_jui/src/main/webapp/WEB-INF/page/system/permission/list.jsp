...
<div class="pageHeader">
	<form id="pagerForm" onsubmit="return navTabSearch(this);" action="${applicationScope.basepath }/system/permission/list" method="post">
		<!-- 分页表单参数 -->
...
<SCRIPT type="text/javascript">
	...
	$("#toInsert",navTab.getCurrentPanel()).click(function(){
		if (level>=2){
		...
		if (id){
			//添加子节点
			$("#permissionBox",navTab.getCurrentPanel()).loadUrl('${applicationScope.basepath}/system/permission/toInsert?id='+id,null,null);
		}else{
			$("#permissionBox",navTab.getCurrentPanel()).loadUrl('${applicationScope.basepath}/system/permission/toInsert', null, null);
		}
		return false;
	});
	$("#toUpdate",navTab.getCurrentPanel()).click(function(){
		if (id){
			$("#permissionBox",navTab.getCurrentPanel()).loadUrl('${applicationScope.basepath}/system/permission/toUpdate?id='+id,null,null);
		}else{
	...
	$("#delect",navTab.getCurrentPanel()).click(function(){
		if (id){
		    ajaxTodo("${applicationScope.basepath}/system/permission/delete?id="+id);
		}else{
